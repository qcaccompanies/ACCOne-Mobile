...
Mobile.tap(findTestObject('BottomMenu/Akun/Akun_Profil/Akun_BtnUbahNoHandphone'), 0)

Mobile.setText(findTestObject('BottomMenu/Akun/Akun_Profil/Akun_InpUbahNoHandphone'), '087824121996', 0)

Mobile.setText(findTestObject('BottomMenu/Akun/Akun_Profil/Akun_InpUbahKonfirmasiNoHandphone'), '012345678', 0)
