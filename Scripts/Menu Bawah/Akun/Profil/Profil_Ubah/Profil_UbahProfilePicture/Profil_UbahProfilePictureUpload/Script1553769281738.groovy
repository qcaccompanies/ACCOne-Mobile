...
Mobile.tap(findTestObject('BottomMenu/Akun/Akun_Profil/Profil_UbahProfilePicture/Profil_BtnGallery'), 0)

Mobile.tap(findTestObject('BottomMenu/Akun/Akun_Profil/Profil_UbahProfilePicture/Profil_BtnChoosePhoto'), 0)
