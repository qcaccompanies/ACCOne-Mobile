...
WebUI.callTestCase(findTestCase('Dashboard/Cari Dana/trade in/master flow/trade in - open menu - MASTER FLOW'), [('varBPKB') : varBPKB], 
...
def estimasiHarga = Mobile.getText(findTestObject('Dashboard/cari dana/trade in/page 1 - masukkan detail kendaraanmu/tradein_TxtEstimasiHarga'), 
    0)

Mobile.verifyMatch(estimasiHarga, varEstimasiHarga, false)
