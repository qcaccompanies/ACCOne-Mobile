...
Mobile.clearText(findTestObject('Dashboard/cari dana/trade in/page 1 - masukkan detail kendaraanmu/TradeIn_InpTahun'), 0)

WebUI.callTestCase(findTestCase('Dashboard/Cari Dana/trade in/master flow/trade in - verify element - page 1 - MASTER FLOW'), 
    [('varBrand') : varBrand, ('varType') : varType, ('varModel') : a, ('varTahun') : '', ('varLokasi') : varLokasi], FailureHandling.CONTINUE_ON_FAILURE)
