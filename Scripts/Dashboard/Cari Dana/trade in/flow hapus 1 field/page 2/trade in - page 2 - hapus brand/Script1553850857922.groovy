...
WebUI.callTestCase(findTestCase('Dashboard/Cari Dana/trade in/flow data binding/trade in - page 1'), [('varBrand') : '', ('varType') : ''
        , ('varModel') : '', ('varTahun') : '', ('varExpectedResult') : '', ('varBPKB') : '', ('varLokasi') : ''], FailureHandling.STOP_ON_FAILURE)
...
Mobile.clearText(findTestObject('Dashboard/cari dana/trade in/page 2 - masukkan detail kendaraan masa depanmu/TradeIn_InpType'), 0)
