...
Mobile.clearText(findTestObject('Dashboard/cari dana/trade in/page 2 - masukkan detail kendaraan masa depanmu/TradeIn_InpModel'), 
    0)

WebUI.callTestCase(findTestCase('Dashboard/Cari Dana/trade in/master flow/trade in - verify element - page 2 - MASTER FLOW'), 
    [('varBrand') : varBrand, ('varType') : varType, ('varModel') : '', ('varTahun') : '', ('varLokasi') : ''], FailureHandling.CONTINUE_ON_FAILURE)
...
switch (varExpectedResult.toString()) {
    case 'PASS':
        ...
        break
    case 'DISABLEDBUTTON':
        Mobile.verifyElementVisible(findTestObject('Dashboard/cari dana/trade in/page 2 - masukkan detail kendaraan masa depanmu/TradeIn_TxtMasukkanDetailKendaraanMasaDepanmu'), 
            7)
