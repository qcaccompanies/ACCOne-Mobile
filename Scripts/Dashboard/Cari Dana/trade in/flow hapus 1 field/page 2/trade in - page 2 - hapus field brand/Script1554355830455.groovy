...
Mobile.clearText(findTestObject('Dashboard/cari dana/trade in/page 2 - masukkan detail kendaraan masa depanmu/TradeIn_InpBrand'), 
    0)

WebUI.callTestCase(findTestCase('Dashboard/Cari Dana/trade in/master flow/trade in - verify element - page 2 - MASTER FLOW'), 
    [('varBrand') : '', ('varType') : '', ('varModel') : '', ('varTahun') : '', ('varLokasi') : ''], FailureHandling.STOP_ON_FAILURE)
