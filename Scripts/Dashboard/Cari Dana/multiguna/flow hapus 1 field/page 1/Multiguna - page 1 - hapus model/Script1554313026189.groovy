...
Mobile.clearText(findTestObject('Dashboard/cari dana/multiguna/page 1 - masukkan detail kendaraanmu/Multiguna_InpModel'), 
    0)
...
WebUI.callTestCase(findTestCase('Dashboard/Cari Dana/multiguna/master flow/Multiguna - verify element - page 1- MASTER FLOW'), 
    [('varBrand') : varBrand, ('varType') : varType, ('varModel') : '', ('varTahun') : ''], FailureHandling.CONTINUE_ON_FAILURE)
