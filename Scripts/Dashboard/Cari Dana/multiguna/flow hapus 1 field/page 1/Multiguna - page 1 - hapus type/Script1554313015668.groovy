...
Mobile.clearText(findTestObject('Dashboard/cari dana/multiguna/page 1 - masukkan detail kendaraanmu/Multiguna_InpType'), 
    0)
...
WebUI.callTestCase(findTestCase('Dashboard/Cari Dana/multiguna/master flow/Multiguna - verify element - page 1- MASTER FLOW'), 
    [('varBrand') : varBrand, ('varType') : '', ('varModel') : '', ('varTahun') : ''], FailureHandling.CONTINUE_ON_FAILURE)
