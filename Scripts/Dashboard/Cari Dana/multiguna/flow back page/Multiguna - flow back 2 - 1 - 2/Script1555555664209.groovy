...
Mobile.verifyElementExist(findTestObject('Dashboard/cari dana/multiguna/page 1 - masukkan detail kendaraanmu/Multiguna_Txtmasukkandetailkendaraanmu'), 
    0)

not_run: WebUI.callTestCase(findTestCase('Dashboard/Cari Dana/multiguna/master flow/Multiguna - verify element - page 1- MASTER FLOW'), 
    [('varBrand') : 'DAIHATSU', ('varType') : 'AYLA', ('varModel') : 'T:1.0 D M/T', ('varTahun') : '2018'], FailureHandling.STOP_ON_FAILURE)
