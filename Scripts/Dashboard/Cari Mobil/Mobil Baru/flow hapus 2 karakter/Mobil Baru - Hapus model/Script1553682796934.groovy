...
Mobile.clearText(findTestObject('Dashboard/Cari Mobil/Mobil Baru/MobilBaru_InpModel'), 0, FailureHandling.STOP_ON_FAILURE)

Mobile.setText(findTestObject('Dashboard/Cari Mobil/Mobil Baru/MobilBaru_InpModel'), '1.0 G A/T N', 0)
