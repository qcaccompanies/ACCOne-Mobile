...
Mobile.clearText(findTestObject('Dashboard/Cari Mobil/Mobil Baru/MobilBaru_InpAreaPengajuan'), 0)

Mobile.setText(findTestObject('Dashboard/Cari Mobil/Mobil Baru/MobilBaru_InpAreaPengajuan'), 'DKI Jakarta, Banten, Jawa Bar', 0)
