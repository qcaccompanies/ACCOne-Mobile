...
CustomKeywords.'mobile.mobileSwipe.UpDown'(0.40, 0.70, 100)

Mobile.clearText(findTestObject('Dashboard/Cari Mobil/Mobil Baru - non paket/MobilBaru_InpOTR'), 0)
...
WebUI.callTestCase(findTestCase('Dashboard/Cari Mobil/Mobil Baru/Non Paket/master flow/Mobil Baru - verify element - MASTER FLOW'), 
    [('varAreaPengajuan') : varAreaPengajuan, ('varCabang') : varCabang, ('varBrand') : varBrand, ('varType') : varType, ('varModel') : varModel
        , ('varTahun') : varTahun, ('varOTR') : '', ('varUangMuka') : '', ('varAngsuran') : 'Rp. ', ('varTDP') : 'Rp. '], 
    FailureHandling.CONTINUE_ON_FAILURE)

CustomKeywords.'mobile.mobileSwipe.UpDown'(0.70, 0.40, 1000)
