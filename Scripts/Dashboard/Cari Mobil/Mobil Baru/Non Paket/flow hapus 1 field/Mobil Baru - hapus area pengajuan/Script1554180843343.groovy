...
Mobile.clearText(findTestObject('Dashboard/Cari Mobil/Mobil Baru - non paket/MobilBaru_InpAreaPengajuan'), 0)
...
WebUI.callTestCase(findTestCase('Dashboard/Cari Mobil/Mobil Baru/Non Paket/master flow/Mobil Baru - verify element - MASTER FLOW'), 
    [('varAreaPengajuan') : '', ('varCabang') : '', ('varBrand') : '', ('varType') : '', ('varModel') : '', ('varTahun') : ''
        , ('varOTR') : '', ('varUangMuka') : '', ('varAngsuran') : 'Rp. ', ('varTDP') : 'Rp. '], FailureHandling.CONTINUE_ON_FAILURE)
