...
Mobile.clearText(findTestObject('Dashboard/Cari Mobil/Mobil Baru - non paket/MobilBaru_InpBrand'), 0)
...
WebUI.callTestCase(findTestCase('Dashboard/Cari Mobil/Mobil Baru/Non Paket/master flow/Mobil Baru - verify element - MASTER FLOW'), 
    [('varAreaPengajuan') : varAreaPengajuan, ('varCabang') : varCabang, ('varBrand') : '', ('varType') : '', ('varModel') : ''
