...
CustomKeywords.'mobile.mobileSwipe.UpDown'(0.40, 0.80, 100)

Mobile.tap(findTestObject('Dashboard/Cari Mobil/Mobil Baru - non paket/MobilBaru_InpAreaPengajuan'), 0)
