...
Mobile.tap(findTestObject('Dashboard/Cari Mobil/Lease/Lease_BtnSubmit'), 0, FailureHandling.OPTIONAL)

switch (varExpectedResult.toString()) {
    case 'PASS':
        Mobile.tap(findTestObject('Dashboard/Cari Mobil/Lease/Lease_BtnOKSuksesDaftar'), 0, FailureHandling.OPTIONAL)

        Mobile.waitForElementPresent(findTestObject('Dashboard/Dashboard_BtnCariDana'), 0, FailureHandling.OPTIONAL)

        Mobile.verifyElementVisible(findTestObject('Dashboard/Dashboard_BtnCariDana'), 0, FailureHandling.OPTIONAL)

        break
    case 'DISABLEDBUTTON':
        Mobile.verifyElementNotVisible(findTestObject('Dashboard/Cari Mobil/Lease/Lease_BtnOKSuksesDaftar'), 0, FailureHandling.OPTIONAL)
