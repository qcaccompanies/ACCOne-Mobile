...
Mobile.waitForElementPresent(findTestObject('Dashboard/Cari Mobil/Lease/Lease_BtnLease'), 0)
...
if (varNewUsed == 'N') {
    Mobile.tap(findTestObject('Dashboard/Cari Mobil/Lease/Lease_BnNewCar'), 0)
}

Mobile.tap(findTestObject('Dashboard/Cari Mobil/Lease/Lease_InpBrand'), 0)

Mobile.setText(findTestObject('Dashboard/Cari Mobil/Lease/Lease_InpBrand'), varBrand, 0)
...
Mobile.setText(findTestObject('Dashboard/Cari Mobil/Lease/Lease_InpType'), varType, 0)
...
Mobile.setText(findTestObject('Dashboard/Cari Mobil/Lease/Lease_InpModel'), varModel, 0)
...
Mobile.setText(findTestObject('Dashboard/Cari Mobil/Lease/Lease_InpTahun'), varTahun, 0)
...
Mobile.setText(findTestObject('Dashboard/Cari Mobil/Lease/Lease_InpAreaPengajuan'), varAreaPengajuan, 0)
...
Mobile.setText(findTestObject('Dashboard/Cari Mobil/Lease/Lease_InpCabang'), varCabang, 0)
