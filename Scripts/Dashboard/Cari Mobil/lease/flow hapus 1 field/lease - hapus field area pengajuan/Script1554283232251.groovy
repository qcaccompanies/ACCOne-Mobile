...
Mobile.clearText(findTestObject('Dashboard/Cari Mobil/Lease/Lease_InpAreaPengajuan'), 0)

WebUI.callTestCase(findTestCase('Dashboard/Cari Mobil/lease/master flow/lease - verify element - MASTER FLOW'), [('varAreaPengajuan') : ''
        , ('varCabang') : '', ('varBrand') : varBrand, ('varType') : varType, ('varModel') : varModel, ('varTahun') : varTahun
...
switch (varExpectedResult.toString()) {
    case 'PASS':
        ...
        break
    case 'DISABLEDBUTTON':
        Mobile.verifyElementNotVisible(findTestObject('Dashboard/Cari Mobil/Lease/Lease_BtnOKSuksesDaftar'), 7)
