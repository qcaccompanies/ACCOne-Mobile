...
WebUI.callTestCase(findTestCase('Dashboard/Cari Mobil/lease/master flow/lease - MASTER FLOW'), [('varAreaPengajuan') : varAreaPengajuan
        ...
        , ('varTypeCustomer') : varTypeCustomer, ('varWarna') : varWarna, ('varPeriode') : varPeriode], FailureHandling.STOP_ON_FAILURE)

Mobile.clearText(findTestObject('Dashboard/Cari Mobil/Lease/Lease_InpType'), 0)
...
WebUI.callTestCase(findTestCase('Dashboard/Cari Mobil/lease/master flow/lease - verify element - MASTER FLOW'), [('varAreaPengajuan') : varAreaPengajuan
        , ('varCabang') : varCabang, ('varBrand') : varBrand, ('varType') : '', ('varModel') : '', ('varTahun') : '', ('varBidangUsaha') : varBidangUsaha], 
