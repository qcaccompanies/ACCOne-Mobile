...
WebUI.callTestCase(findTestCase('Dashboard/Login/Login/master flow/Login - MASTER FLOW'), [('varUsername') : 'notverified@a.c', ('varPassword') : 'Password1!'
        , ('varExpectedResult') : 'NO'], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Dashboard/Cari Mobil/lease/master flow/lease - MASTER FLOW'), [('varAreaPengajuan') : varAreaPengajuan
        ...
        , ('varTypeCustomer') : varTypeCustomer, ('varPeriode') : varPeriode], FailureHandling.STOP_ON_FAILURE)
