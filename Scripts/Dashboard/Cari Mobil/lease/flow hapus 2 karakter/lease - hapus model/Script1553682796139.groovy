...
Mobile.clearText(findTestObject('Dashboard/Cari Mobil/Lease/Lease_InpModel'), 0)

Mobile.setText(findTestObject('Dashboard/Cari Mobil/Lease/Lease_InpModel'), '1.0 G A/T N', 0)
