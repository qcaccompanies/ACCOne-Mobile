...
suiteProperties.put('id', 'Test Suites/MOBILE_TS_Multiguna - data binding - page 2 (1-5)')

suiteProperties.put('name', 'MOBILE_TS_Multiguna - data binding - page 2 (1-5)')
